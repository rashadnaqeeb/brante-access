namespace BranteAccess.Module.Input
{
    ...
    /// InputManager; controller bindings can be added later as a sibling. Ported from wotr-access.
    /// </summary>
    public abstract class InputBinding
    {
        ...
        // rebind makes a NEW binding - so this is constant and cached: InputManager.RebuildLive runs
        // every frame and rebuilding this string per binding dominated wotr's per-frame allocation.

...
namespace BranteAccess.Speech
{
    ...
    /// wotr-access. prism.dll sits next to the game exe; it talks to NVDA etc. directly.
    /// </summary>
    internal static class PrismNative
    {
        ...
        // Marshal.PtrToStringUTF8 doesn't exist on net4x - read to the null terminator ourselves.
